...
public class TableWriter {
    ...
    public void write(Collection<? extends Attributable> element, String filename) throws IOException {
    ...
    private Set<String> collectAttributes(Collection<? extends Attributable> persons) {
