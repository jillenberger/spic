...
//        Discretizer discretizer = new StackedDiscreitzer();
        ...
        ZoneCollection zones = ((ZoneData) engine.getDataPool().get(ZoneDataLoader.KEY)).getLayer("modena");
...
//                hamiltonians.add(null);
    ...
    private static TObjectIntMap indexZones(Set<? extends Person> simPersons, ActivityFacilities facilities,
        ...
        TDoubleArrayList rhos = new TDoubleArrayList();
        ...
        for (Person person : simPersons) {
            ...
            if (f == null) {
                ...
                if (z != null) {
                    ...
                    if(idx == -1) {
                        String val = z.getAttribute(ZoneFacilityDensity.FACILITY_DENSITY_KEY);
                        if (val != null) {
                            double rho = Double.parseDouble(val);
                            idx = discr.index(rho);
                        } else {
                            idx = 0;
                        }
